...
async function initMeasureTemperatureDevice(device, zclNode, { capabilityId = 'measure_temperature', cluster = zigbee_clusters_1.CLUSTER.TEMPERATURE_MEASUREMENT, attributeName = 'measuredValue', minChange = 10, maxInterval, endpointId, } = {}) {
