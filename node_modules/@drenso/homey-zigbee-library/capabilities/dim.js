...
async function initDimDevice(device, zclNode, { capabilityId = 'dim', onOffCapabilityId = 'onoff', maxDimValue = 0xFE, maxInterval, minChange, endpointId, } = {}) {
    ...
    }, minChange, endpointId, maxInterval);
}
